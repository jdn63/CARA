...
CARA assesses risk across five domains with the following weights:

| Domain | Weight | Description |
|--------|--------|-------------|
| Natural Hazards | 35% | FEMA NRI data, weather events |
| Health Metrics | 20% | Disease surveillance, SVI |
| Active Shooter | 15% | School safety, venue analysis |
| Extreme Heat | 15% | Heat vulnerability, forecasts |
| Cybersecurity | 15% | Infrastructure vulnerability |
