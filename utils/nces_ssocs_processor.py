...
class NCESSchoolSafetyProcessor:
    ...
    def _process_wi_counties(self):
        """Process Wisconsin data by county"""
        # SSOCS does not publish county-level data; this method uses state-level
        # SSOCS statistics distributed to counties via school district enrollment
        # weights, which is the standard approach for county-level school safety estimation
