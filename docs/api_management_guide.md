...
```json
{
  ...
  "services": {
    ...
    "FBI_CRIME_DATA_API_KEY": {
      "configured": false,
      "valid": false,
      "status": "Not used - FBI CJIS access restricted to authorized government endpoints; active shooter domain uses GVA data only",
      "last_checked": "2026-04-06T00:00:00.000000"
    }
  },
...
2. **FBI_CRIME_DATA_API_KEY** - Not used. FBI CJIS/UCR/NIBRS access is restricted to authorized government endpoints. The active shooter domain uses Gun Violence Archive (GVA) data instead.
